...
namespace PopulateNewProviderCollections.DataModels
{
    ...
    public class DgProvider
    {
        ...
        public string[] TypeAhead_Name { get; set; }
        public string[] TypeAhead_Specialties { get; set; }
        public object TypeAhead_Specialties_PrimaryCare { get; set; }
        public string[] TypeAhead_ScopeOfPractices { get; set; }
        public string[] TypeAhead_Insurances { get; set; }
